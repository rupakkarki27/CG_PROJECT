...
namespace models{
	void track(){
		if(trackTex == 0)
			trackTex=loadTexture("C:\\Users\\Himalaya K.P. Campus\\Desktop\\RUPAK\\ONLY-CODEBLOCKS\\Runner\\train2.bmp");
	...
	void greenGround(){
		if(grassTex==0)
			grassTex=loadTexture("C:\\Users\\Himalaya K.P. Campus\\Desktop\\RUPAK\\ONLY-CODEBLOCKS\\Runner\\grass4.bmp");
	...
	void sky(){
		if(skyTex==0)
			skyTex = loadTexture("C:\\Users\\Himalaya K.P. Campus\\Desktop\\RUPAK\\ONLY-CODEBLOCKS\\Runner\\sky_new.jpg");
